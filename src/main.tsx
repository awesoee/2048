...
import LittleAlchemy2Plugin from './LittleAlchemy2Plugin';
...
FrayToolsPluginCore.setupHandler = (props) => {
  ...
  appContainer.className = 'LittleAlchemy2Wrapper';
  document.body.appendChild(appContainer);

  // Load the component with its props into the document body
  ReactDOM.render(<LittleAlchemy2Plugin {...props}/>, appContainer);
};
